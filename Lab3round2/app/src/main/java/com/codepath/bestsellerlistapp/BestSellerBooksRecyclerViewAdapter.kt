...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mBookRank: TextView = mView.findViewById(id.ranking) as TextView
        ...
        val mBuyButton: Button = mView.findViewById(id.buy_button) as Button
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.mBookRank.text = (position + 1).toString()

        holder.mBuyButton.setOnClickListener {
            // Use an Intent to open the amazonUrl in the device's browser
